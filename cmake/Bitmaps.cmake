macro(add_bitmaps_target targetname filter width format)
  ...
  foreach(bitmap ${bitmaps})
    ...
    add_custom_command(
      OUTPUT ${target}
      COMMAND ${Python3_EXECUTABLE} ${RADIO_DIRECTORY}/util/img2lbm.py ${bitmap} ${target} ${width} ${format} ${ARGN}
      DEPENDS ${bitmap}
    )
...
macro(add_truetype_font_target radio name font size offset)
  ...
  add_custom_target(ttf_${radio}_${name}
    COMMAND ${Python3_EXECUTABLE} ${RADIO_DIRECTORY}/util/font2png.py ${font} ${size} ${offset} ${target}
